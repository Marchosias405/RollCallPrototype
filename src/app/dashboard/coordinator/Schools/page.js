...
export default function CoordinatorSchools() {
  // ---------- Retrieve Date ----------
  const [schools, setSchools] = useState([]); // attendance
              ...
              {expandedSchools[school.id] && (
                <div className="mt-4 pl-4 border-l-4 border-blue-500">
                  ...
                  {school.course_ids && school.course_ids.length > 0 ? (
                    ...
                    <p className="text-gray-600">No courses available for this school.</p>
                  )}
                </div>
              )}
            </li>
